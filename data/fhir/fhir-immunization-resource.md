# SOURCE: FHIR R4 Immunization Resource — Cerner Implementation
# URL: https://raw.githubusercontent.com/cerner/fhir.cerner.com/main/content/millennium/r4/clinical/medications/immunization.md
...
- When  searching with `_lastUpdated` parameter: 
  - It can be provided with only a single reference, and must use the `gt` or `ge` prefix
  - The time component is optional.
